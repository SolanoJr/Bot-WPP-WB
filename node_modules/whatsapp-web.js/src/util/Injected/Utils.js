...
exports.LoadUtils = () => {
    ...
    window.WWebJS.sendMessage = async (chat, content, options = {}) => {
        ...
        console.log('[WWebJS.sendMessage] BEFORE Msg.get() - newMsgKey._serialized:', newMsgKey?._serialized, 'newMsgKey.id:', newMsgKey?.id);
        console.log('[WWebJS.sendMessage] AFTER Msg.get() - resultMsg:', !!resultMsg, 'resultMsg?.id:', resultMsg?.id, 'resultMsg?.id._serialized:', resultMsg?.id?._serialized);
