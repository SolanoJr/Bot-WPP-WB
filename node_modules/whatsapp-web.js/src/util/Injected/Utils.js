...
exports.LoadUtils = () => {
    ...
    window.WWebJS.sendMessage = async (chat, content, options = {}) => {
        ...
        // LOG DIAGNÓSTICO: Verificar o comportamento real do Msg.get()
        const msgKeyId = window.WWebJS.getMsgKeyId(newMsgKey);
        const storeMsgGet = window.require('WAWebCollections').Msg.get;
        const storeHas = window.require('WAWebCollections').Msg.has;
        const storeSize = window.require('WAWebCollections').Msg.size;
        
        console.log('[WWebJS.sendMessage] BEFORE Msg.get()');
        console.log('[WWebJS.sendMessage] newMsgKey:', newMsgKey);
        console.log('[WWebJS.sendMessage] newMsgKey._serialized:', newMsgKey?._serialized);
        console.log('[WWebJS.sendMessage] newMsgKey.id:', newMsgKey?.id);
        console.log('[WWebJS.sendMessage] newMsgKey.type:', typeof newMsgKey);
        console.log('[WWebJS.sendMessage] msgKeyId (após getMsgKeyId):', msgKeyId);
        console.log('[WWebJS.sendMessage] Store.Msg.has(msgKeyId):', storeMsgGet ? storeMsgGet(msgKeyId) ? 'true (objeto)' : 'false (não existe)' : 'Store.Msg.get não disponível');
        console.log('[WWebJS.sendMessage] Store.Msg.size:', storeSize);
        
        console.log('[WWebJS.sendMessage] AFTER Msg.get() - resultMsg:', resultMsg);
        console.log('[WWebJS.sendMessage] typeof resultMsg:', typeof resultMsg);
        console.log('[WWebJS.sendMessage] resultMsg === false:', resultMsg === false);
        console.log('[WWebJS.sendMessage] resultMsg === undefined:', resultMsg === undefined);
        console.log('[WWebJS.sendMessage] resultMsg === null:', resultMsg === null);
        console.log('[WWebJS.sendMessage] resultMsg?.id:', resultMsg?.id);
        console.log('[WWebJS.sendMessage] resultMsg?.id === false:', resultMsg?.id === false);
        console.log('[WWebJS.sendMessage] resultMsg?.id type:', typeof resultMsg?.id);
        console.log('[WWebJS.sendMessage] resultMsg?.id === undefined:', resultMsg?.id === undefined);
        console.log('[WWebJS.sendMessage] resultMsg?.id === null:', resultMsg?.id === null);
        console.log('[WWebJS.sendMessage] Object.keys(resultMsg || {}):', resultMsg ? Object.keys(resultMsg) : 'N/A');
